...
When the user reacts to what a memory said, declare it in the same call:
verdict="confirmed" if they confirmed it, verdict="corrected" if they corrected
or contradicted it. That is the confidence loop — memories the user keeps
confirming earn trust, memories the user keeps correcting lose it — and it costs
nothing beyond the declaration you owe anyway.
...
---
<!-- valorbrain-contract: v2 harness: grok -->
